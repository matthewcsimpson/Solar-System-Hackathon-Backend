...
const {
  getAllBodies,
  getAllBodiesDetailed,
} = require("../controllers/getAllBodiesController");
const {
  getAllPlanets,
  getAllDwarfPlanets,
  getAllLargePlanets,
...
router.get("/planets/detail", getAllPlanetsDetail)
