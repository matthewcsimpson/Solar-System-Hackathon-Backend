...
const getAllBodiesDetailed = async (req, res) => {
  let starData = await knex("star")
    .select("star_id", "englishName", "meanRadius")
    .then((starData) => {
      return starData;
  ...
  let moonData = await knex("moons")
    .select({
      ...
      englishName: "moons.englishName",
      meanRadius: "moons.meanRadius",
      perihelion: "moons.perihelion",
      aphelion: "moons.aphelion",
      sideralOrbit: "moons.sideralOrbit",
      sideralRotation: "moons.sideralRotation",
      inclination: "moons.inclination",
      planet_id: "moons.planet_id",
      planetEnglishName: "planets.englishName",
    })
    .join("planets", "moons.planet_id", "planets.planet_id")
...
module.exports = { getAllBodies, getAllBodiesDetailed };
